...
struct HotRacePage: Decodable { let revision: String; let note: String; let races: [HotRace] }
struct HotRace: Decodable, Identifiable {
    let id: String; let chamber: String; let district: Int; let candidates: [RaceCandidate]
