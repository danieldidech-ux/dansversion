...
def create_app(directory=None, poll=True):
    ...
    @app.get('/downloads/IllinoisTracker-v28.zip')
    def download28_iphone_project():
        archive = Path(__file__).resolve().parent.parent / 'releases' / 'Checks-and-Balances-iPhone-v28.zip'
        return send_file(archive, mimetype='application/zip', as_attachment=True, download_name='Checks-and-Balances-iPhone-v28.zip', conditional=True)
    ...
    def download26_iphone_project():
        ...
        return send_file(archive, mimetype='application/zip', as_attachment=True, download_name='Checks-and-Balances-iPhone-v26.zip', conditional=True)

    @app.get('/downloads/IllinoisTracker-v25.zip')
    def download25_iphone_project():
        archive = Path(__file__).resolve().parent.parent / 'releases' / 'Checks-and-Balances-iPhone-v25.zip'
        return send_file(archive, mimetype='application/zip', as_attachment=True, download_name='Checks-and-Balances-iPhone-v25.zip', conditional=True)
    ...
    def download23_iphone_project():
        archive = Path(__file__).resolve().parent.parent / 'releases' / 'IllinoisTracker-iPhone-Source-v23.zip'
        return send_file(archive, mimetype='application/zip', as_attachment=True, download_name='IllinoisTracker-iPhone-Source-v23.zip', conditional=True)

    @app.get('/downloads/IllinoisTracker-v22.zip')
    def download22_iphone_project():
        archive = Path(__file__).resolve().parent.parent / 'releases' / 'IllinoisTracker-iPhone-Source-v22.zip'
        return send_file(archive, mimetype='application/zip', as_attachment=True, download_name='IllinoisTracker-iPhone-Source-v22.zip', conditional=True)
